...
@WebServlet(
        name = "Bank Issuer",
        urlPatterns = {"/bank-issuer"}
)
public class BankIssuer extends HttpServlet {
...
//        out.close();
        ...
        out.println("<br><h1> Bank Issuer </h1> <br>");
        out.println("<h2> Scan and get your verifiable credential </h2>");
        out.println("<div class=\"container-fluid\">\n" +
                "    <div class=\"text-center\">\n" +
                "        <img src=\"https://chart.googleapis.com/chart?cht=qr&chl=192.168.1.2:6666&chs=160x160&chld=L|0\"\n" +
