...
@WebServlet(
        name = "Credit Score Issuer",
        urlPatterns = {"/credit-score-issuer"}
)
public class CreditScoreIssuer extends HttpServlet {
...
//        out.close();
        ...
        out.println("<meta charset=\"UTF-8\">\n" +
                ...
                "    <title>Credit Score Issuer</title>\n" +
                "    <link rel=\"stylesheet\"\n" +
        ...
        out.println("<br><h1> Credit Score Issuer </h1> <br>");
        out.println("<h2> Scan and get your verifiable credential </h2>");
        out.println("<div class=\"container-fluid\">\n" +
                "    <div class=\"text-center\">\n" +
                "        <img src=\"https://chart.googleapis.com/chart?cht=qr&chl=192.168.1.2:8888&chs=160x160&chld=L|0\"\n" +
